...
TEXT ·IsAlphaNumericSIMD(SB),NOSPLIT,$0-17
	...
	MOVD s_base+0(FP), R_STR_PTR
	MOVD s_len+8(FP), R_STR_LEN
	VMOVI $64, V_64.B16
...
loop:
	...
	VLD1.P 16(R_STR_PTR), [V_STR_LO.B16]
	VSUB V_64.B16, V_STR_LO.B16, V_STR_HI.B16
	VTBL V_STR_LO.B16, [V_TBL0.B16, V_TBL1.B16, V_TBL2.B16, V_TBL3.B16], V_RES_LO.B16
	VTBL V_STR_HI.B16, [V_TBL4.B16, V_TBL5.B16, V_TBL6.B16, V_TBL7.B16], V_RES_HI.B16
	...
	CBNZ R_TMP, return_false
	// decrement remaining str len and keep looping if needed
	SUBS $16, R_STR_LEN, R_STR_LEN
	BNE loop
return_true:
	MOVW $1, R_TMP
